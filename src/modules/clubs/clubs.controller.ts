...
export class ClubsController {
  ...
  @ApiParam({ name: 'id', description: "Club identificator", example: "f87fe938-df16-4c77-919e-6d31d06690f0"})
  @ApiResponse({ status: 200, description: "Club found", type: CreateClubDto })
  @ApiResponse({ status: 404, description: "Club doesn't found" })
  async findOne(@Param('id', new ParseUUIDPipe()) id: string): Promise<CreateClubDto> {
  ...
  @ApiParam({name: "id", description: "Club identificator", example: "f87fe938-df16-4c77-919e-6d31d06690f0"})
  @ApiResponse({status: 200, description: "Club updated", type: CreateClubDto})
  @ApiResponse({status: 404, description: "Update error"})
  async update(@Param('id', new ParseUUIDPipe()) id: string, @Body() updateClubDto: UpdateClubDto): Promise<UpdateClubDto> {
