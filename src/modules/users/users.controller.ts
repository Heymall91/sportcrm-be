import { Controller, Get, Post, Body, Patch, Param, Delete, ValidationPipe, UsePipes, ParseUUIDPipe, HttpCode } from '@nestjs/common';
...
export class UsersController {
  ...
  async findOne(@Param('id', new ParseUUIDPipe()) id: string): Promise<CreateUserDto> {
  ...
  async update(@Param('id', new ParseUUIDPipe()) id: string, @Body() updateUserDto: UpdateUserDto): Promise<UpdateUserDto> {
